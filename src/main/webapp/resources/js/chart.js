...
//		    , h = [201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312,201401,201402,201403,201404,201405,201406,201407,201408,201409,201410,201411,201412,201501,201502,201503,201504,201505,201506,201507,201508,201509,201510,201511,201512,201601,201602,201603,201604,201605,201606,201607,201608,201609,201610,201611,201612,201701,201702,201703,201704,201705,201706,201707,201708,201709,201710,201711,201712,201801,201802,201803,201804,201805,201806,201807];
		, h = n.years = f.default.range(1, 70);
//		    h=[201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312,201401,201402,201403,201404,201405,201406,201407,201408,201409,201410,201411,201412,201501,201502,201503,201504,201505,201506,201507,201508,201509,201510,201511,201512,201601,201602,201603,201604,201605,201606,201607,201608,201609,201610,201611,201612,201701,201702,201703,201704,201705,201706,201707,201708,201709,201710,201711,201712,201801,201802,201803,201804,201805,201806,201807];
	...
	, function(t, n, e) {
		...
		n.default = {
				...
				mounted: function() {
					...
					u.json("resources/forenames.json", function(e, r) {
						if (e)
					...
					this.$el.addEventListener("mousemove", function(n) {
						if (t.popup.show) {
							...
							t.popup.position = e < t.$el.offsetWidth / 2 ? "right" : null,
									t.currentYear = Math.round(t.xScale.invert(e)),
				...
				methods: {
					...
					updateAxis: function() {
						...
						var t = Math.max(1.1 * (0,
								c.maxBirthsCount)(this.forenames, this.range), 150);
				...
				methods: {
					countForForename: function(t) {
						...
						, e = o.default.find(t.births, function(t) {
							var monthDate = [201301,201302,201303,201304,201305,201306,201307,201308,201309,201310,201311,201312,201401,201402,201403,201404,201405,201406,201407,201408,201409,201410,201411,201412,201501,201502,201503,201504,201505,201506,201507,201508,201509,201510,201511,201512,201601,201602,201603,201604,201605,201606,201607,201608,201609,201610,201611,201612,201701,201702,201703,201704,201705,201706,201707,201708,201709,201710,201711,201712,201801,201802,201803,201804,201805,201806,201807];  
	...
	, function(t, n, e) {
		t.exports = {
				...
				staticRenderFns: [function() {
					...
					return e("div", {
						staticClass: "title"
					}, [e("h2", [t._v("Marvel Stats :")]), e("h1", [t._v("캐릭터 이름 Google 검색량")])])
				}
				, function() {
					var t = this
					, n = t.$createElement
